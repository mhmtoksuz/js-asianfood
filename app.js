...
// Get Categories 
const categories = menu.reduce((cat, element) => {
...
//Buttons
const buttons = categories.map(element => {
...
function updateList() {
  ...
  const items = category === "All" ? menu : menu.filter(element => element.category == category);
